 ...
 */
@TableName("kaoqinyujing")
public class KaoqinyujingEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public KaoqinyujingEntity() {
		
	}
	
	public KaoqinyujingEntity(T t) {
		try {
	 ...
	 * 设置：考勤预警
	 */
	public void setKaoqinyujing(String kaoqinyujing) {
		this.kaoqinyujing = kaoqinyujing;
	}
	/**
	 * 获取：考勤预警
	 */
	public String getKaoqinyujing() {
		return kaoqinyujing;
	}
}
