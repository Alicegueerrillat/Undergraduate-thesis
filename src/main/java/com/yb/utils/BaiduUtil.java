...
public class BaiduUtil {
     ...
     * @return
     */
    public static Map<String, String> getCityByLonLat(String key, String lng, String lat) {  //逆地理编码，返回省/市/区/街道
    ...
    public static String getAuth(String ak, String sk) {
        // 获取token地址
        String authHost = "https://aip.baidubce.com/oauth/2.0/token?"; // OAuth2.0协议被广泛用于授权管理。它允许第三方应用在获得用户许可后，访问用户在某个服务上的资源，而不需要将用户的用户名和密码透露给第三方应用
