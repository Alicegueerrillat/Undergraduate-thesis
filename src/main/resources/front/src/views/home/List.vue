...
let { stop: aboutusStop } = useIntersectionObserver(
  ...
  ([{ isIntersecting }]) => {
    if (isIntersecting) {
      ...
      animateClass.value = 'animate__animated animate__fadeInLeft'
...
.goods-7 {
  ...
  padding-top: 20px;
  padding-bottom: 30px;
  background: url(http://codegen.caihongy.cn/20251011/3fc62be7a0e246c6a3974c69da2489fe.jpg) no-repeat top center;
